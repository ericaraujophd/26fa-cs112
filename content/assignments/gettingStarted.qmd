...
- Create a GitHub account, join the course organization, and accept an assignment.
...
Each assignment in CS112 is distributed through **Classroom 50**. When you accept an assignment, GitHub automatically creates a private repository just for you with the starter code already inside. Only you and the instructor can see it.

::: {.callout-important}
Get the **Getting Started accept link from Moodle** and open it there.

All CS112 accept links are distributed through Moodle so that only Calvin students can accept assignments.

You will need to be a member of the **26fa-cs112** GitHub organization first — you should have received an email invitation. Accept that invitation before using the link. If you never got one, tell the instructor which GitHub username you are using.

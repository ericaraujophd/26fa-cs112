...
4. Skip any personalization steps by clicking "Skip Personalization" at the bottom.
...
**Then send me your username.** There is no self-service sign-up for CS112. I
create a private repository for you, one per assignment, from the class roster —
and that roster is built by hand from the usernames students send in. Nothing is
created for you until yours is on it.
...
::: {.callout-note}
Your repository is named `cs112-a00-YOURUSERNAME`, all in lowercase. Every
assignment follows the same pattern: `cs112-<assignment>-<your username>`.
:::
...
In your VS Code terminal, make sure you are inside your `cs112-a00-YOURUSERNAME` directory. Then type:
